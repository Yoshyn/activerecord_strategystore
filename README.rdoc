...
soft.strategy                         # nil
soft.available_strategies             # [FirstSoftwareStrategy, SecondSoftwareStrategy]

soft.strategy = FirstSoftwareStrategy # Can also be string
...
If you need to have 2 différents strategy in différent model, you will have to
register manualy your strategy like this :
...
class Sofware
  acts_as_strategy_store(:settings, strategy_ui_id: :software)
end
